...
void vPemindahanData(){
  ...
  readkec7[indexMA] = safeValue(data[19]).toFloat();
  readUkec1[indexMA] = safeValue(data[23]).toFloat();
  readUkec2[indexMA] = safeValue(data[28]).toFloat();
...
SuhuDS1          = safeValue(data[37]).toFloat();
BME1             = safeValue(data[38]).toFloat();
...
SuhuDS2          = safeValue(data[52]).toFloat();
BME2             = safeValue(data[53]).toFloat();
...
SuhuDS3          = safeValue(data[66]).toFloat();
BME3             = safeValue(data[67]).toFloat();
