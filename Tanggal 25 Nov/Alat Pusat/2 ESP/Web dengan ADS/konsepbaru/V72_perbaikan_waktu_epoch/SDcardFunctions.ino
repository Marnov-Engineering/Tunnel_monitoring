...
void writeBufferTunnel(const char* path) {
  if(xSemaphoreTake(sdCardMutex, pdMS_TO_TICKS(50000)) == pdTRUE){
    ...
    sprintf(buffer,
          ...
          waktuUpdate, suhu1.c_str(), Humid1.c_str(), kec1.c_str(),
          waktuUpdate, suhu2.c_str(), Humid2.c_str(), kec2.c_str(),
          waktuUpdate, suhu3.c_str(), Humid3.c_str(), kec3.c_str(),
          waktuUpdate, suhu4.c_str(), Humid4.c_str(), kec4.c_str(),
          waktuUpdate, suhu5.c_str(), Humid5.c_str(), kec5.c_str(),
          waktuUpdate, suhu6.c_str(), Humid6.c_str(), kec6.c_str(),
          waktuUpdate, suhu7.c_str(), Humid7.c_str(), kec7.c_str(),
          waktuUpdate, Usuhu1.c_str(), UHumid1.c_str(), Ukec1.c_str(),  USDP1.c_str(), USDPSekitar1.c_str(),Watt1,
          waktuUpdate, Usuhu2.c_str(), UHumid2.c_str(), Ukec2.c_str(),  USDP2.c_str(), USDPSekitar1.c_str(),Watt2,
          waktuUpdate,SuhuDS1,
          waktuUpdate,SuhuDS2,
          waktuUpdate,SuhuDS3,
          waktuUpdate,BME1,
