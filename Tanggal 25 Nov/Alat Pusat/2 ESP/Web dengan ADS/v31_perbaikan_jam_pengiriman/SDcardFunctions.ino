...
void writeBufferTunnel(const char* path) {
  ...
  // Serial.println("BufferFirebase tunnel data");
  // Serial.println(BufferFirebase);
  
  appendFile(SD, path, BufferSDcard);
  sprintf(BufferSDcard, "0,%lu,nan,nan,nan,nan,nan,nan,nan,nan\n", waktuUpdate);
  // tulis ke file
