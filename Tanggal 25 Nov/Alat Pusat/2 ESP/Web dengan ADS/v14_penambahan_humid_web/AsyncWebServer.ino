String vSendData() {
  ...
  sprintf(data, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%.5f,%.5f,%.5f,%d,%d,%d",  
...
String vSendDataHeat() {
  char data[300];  // Sesuaikan ukuran buffer jika perlu

  DindSuhu1 = SuhuDS1;
  DindSuhu2 = SuhuDS2;
  DindSuhu3 = SuhuDS3;

  sprintf(data, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.2f,%.2f,%.2f,%d,%d,%d,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%d,%d,%d,%.5f,%.5f,%.5f", 
  Suhu_Tunnel_1, Power_Tunnel_1, Heater_st_1, Fan_Power_1, 
  Suhu_Tunnel_2, Power_Tunnel_2, Heater_st_2, Fan_Power_2, 
  Suhu_Tunnel_3, Power_Tunnel_3, Heater_st_3, Fan_Power_3, 
...
void vAsyncWebServer() {
  ...
  // });
    ...
    server.on("/data", HTTP_GET, [](AsyncWebServerRequest *request){
      ...
      json += "\"Psuhu1\":" + safeValue(SBME1)+ ",";
      json += "\"Psuhu2\":" + safeValue(SBME2)+ ",";
      json += "\"Psuhu3\":" + safeValue(SBME3)+ ",";

      json += "\"Humid1\":" + safeValue(Humid1)+ ",";
      json += "\"Humid2\":" + safeValue(Humid2)+ ",";
      json += "\"Humid3\":" + safeValue(Humid3)+ ",";
      json += "\"Humid4\":" + safeValue(Humid4)+ ",";
      json += "\"Humid5\":" + safeValue(Humid5)+ ",";
      json += "\"Humid6\":" + safeValue(Humid6)+ ",";
      json += "\"Humid7\":" + safeValue(Humid7)+ ",";
      json += "\"UHumid1\":" + safeValue(UHumid1)+ ",";
      json += "\"UHumid2\":" + safeValue(UHumid2)+ ",";
