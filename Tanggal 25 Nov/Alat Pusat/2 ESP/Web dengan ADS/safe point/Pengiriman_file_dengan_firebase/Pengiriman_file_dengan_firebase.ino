...
static const char* SERVER_NAME = "ptsv3.com"; // host only
static const char* SERVER_PATH = "/gas-monitor"; // path starting with '/'
static const int SERVER_PORT = 443; // 443 for HTTPS
static const char* SD_FILE_PATH = "/CSVSpread/1760601368.txt"; // change to your SD file
