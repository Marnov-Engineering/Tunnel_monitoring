/* 
  1. perubahan parsing serial diganti dengan versi 55
...
String data[71];  // Stores data1 to data20
...
void vSetupEEPROM(){
  ...
  IntervalKirimServerMillis = iTimeReportPeriodic * 10000;
  ...
  preferences.getBytes("SensUjn1", &sensorUjung2, sizeof(sensorUjung2));
...
void parseSerialData(String input) {
  ...
  SuhuDS1         = data[36].toFloat();
  BME1            = data[37].toFloat();
  ...
  // ================= HEATER 2 =================
  Heater_st_2     = data[45].toInt();
  Fan_Power_2     = data[46].toInt();
  Power_Tunnel_2  = data[47].toInt();
  WCSstate2       = !data[48].toInt();
  SuhuDS2         = data[49].toFloat();
  BME2            = data[50].toFloat();
  setpoint2       = data[51].toFloat();
  kp2             = data[52].toFloat();
  ki2             = data[53].toFloat();
  kd2             = data[54].toFloat();
  out_pid2        = data[55].toFloat();
  CalM_DinD2      = data[56].toFloat();
  CalB_DinD2      = data[57].toFloat();

  // ================= HEATER 3 =================
  Heater_st_3     = data[58].toInt();
  Fan_Power_3     = data[59].toInt();
  Power_Tunnel_3  = data[60].toInt();
  WCSstate3       = !data[61].toInt();
  SuhuDS3         = data[62].toFloat();
  BME3            = data[63].toFloat();
  setpoint3       = data[64].toFloat();
  kp3             = data[65].toFloat();
  ki3             = data[66].toFloat();
  kd3             = data[67].toFloat();
  out_pid3        = data[68].toFloat();
  CalM_DinD3      = data[69].toFloat();
  CalB_DinD3      = data[70].toFloat();
