...
String vSendDataHeat() {
  ...
  sprintf(data, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.2f,%.2f,%.2f", Suhu_Tunnel_1, Power_Tunnel_1, Heater_st_1, Fan_Power_1, Suhu_Tunnel_2, Power_Tunnel_2, Heater_st_2, Fan_Power_2, Suhu_Tunnel_3, Power_Tunnel_3, Heater_st_3, Fan_Power_3, CalM_DinD1, CalB_DinD1, CalM_DinD2, CalB_DinD2, CalM_DinD3, CalB_DinD3, DindSuhu1, DindSuhu2, DindSuhu3);
