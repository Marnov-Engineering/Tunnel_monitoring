...
const char* KEY = "AKfycbyvVXgKdWWj_LrxVOOdJN3ap4zXsu_gPwABY8-Y3Pa_Y052YgZnb4X1AVIn9mTLFulc4w";
...
void accessToGoogleSheets() {
  ...
  sprintf(httpRequestData, "/exec?Time=%lu000&S1=%s&S2=%s&S3=%s&S4=%s&S5=%s&S6=%s&S7=%s&SU1=%s&SU2=%s&SD1=%.2f&SD2=%.2f&SD3=%.2f&SP1=%.2f&SP2=%.2f&SP3=%.2f&H1=%s&H2=%s&H3=%s&H4=%s&H5=%s&H6=%s&H7=%s&HU1=%s&HU2=%s&K1=%s&K2=%s&K3=%s&K4=%s&K5=%s&K6=%s&K7=%s&KU1=%s&KU2=%s&PU1=%s&PU2=%s&PID1=%.2f&PID2=%.2f&PID3=%.2f",
  epochTime,
