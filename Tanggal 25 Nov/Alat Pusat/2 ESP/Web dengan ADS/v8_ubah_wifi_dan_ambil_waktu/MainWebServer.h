...
<head>
  ...
  <script src="SuhuData.js"></script>
  <script src="WindData.js"></script>
  <script src="TekananData.js"></script>
  ...
  <script>
    ...
    async function fetchData() {
      try {
        ...
        chart2.series[0].addPoint([x, data.USDP1]);
        chart2.series[1].addPoint([x, data.USDP2]);

        // Jika data.suhu adalah array
        chart1.series[0].addPoint([x, data.Usuhu1]);
        chart1.series[1].addPoint([x, data.Usuhu2]);
        chart1.series[2].addPoint([x, data.suhu1]);
        chart1.series[3].addPoint([x, data.suhu2]);
        chart1.series[4].addPoint([x, data.suhu3]);
        chart1.series[5].addPoint([x, data.suhu4]);
        chart1.series[6].addPoint([x, data.suhu5]);
        chart1.series[7].addPoint([x, data.suhu6]);
        chart1.series[8].addPoint([x, data.suhu7]);

        chart3.series[0].addPoint([x, data.Ukec1]);
        chart3.series[1].addPoint([x, data.Ukec2]);
        chart3.series[2].addPoint([x, data.kec1]);
        chart3.series[3].addPoint([x, data.kec2]);
        chart3.series[4].addPoint([x, data.kec3]);
        chart3.series[5].addPoint([x, data.kec4]);
        chart3.series[6].addPoint([x, data.kec5]);
        chart3.series[7].addPoint([x, data.kec6]);
        chart3.series[8].addPoint([x, data.kec7]);
