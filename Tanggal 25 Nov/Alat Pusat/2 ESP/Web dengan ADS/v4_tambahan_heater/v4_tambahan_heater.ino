...
String vSendDataHeat() {
  ...
  DindSuhu2 = SuhuDS2;
  DindSuhu3 = SuhuDS3;
  sprintf(data, "%d,%d,%d,%d,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.2f,%.2f,%.2f", Suhu_Tunnel, Power_Tunnel, Heater_st, Fan_Power, CalM_DinD1, CalB_DinD1, CalM_DinD2, CalB_DinD2, CalM_DinD3, CalB_DinD3, DindSuhu1, DindSuhu2, DindSuhu3);
