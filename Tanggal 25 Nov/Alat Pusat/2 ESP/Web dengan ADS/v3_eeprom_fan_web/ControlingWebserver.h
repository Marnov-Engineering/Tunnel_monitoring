    ...
    setInterval(function () {
      ...
      xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          ...
          document.getElementById("CalM_DinD1").innerHTML = parseFloat(data[2]).toFixed(5);
          document.getElementById("CalB_DinD1").innerHTML = parseFloat(data[3]).toFixed(5);

          document.getElementById("CalM_DinD2").innerHTML = parseFloat(data[4]).toFixed(5);
          document.getElementById("CalB_DinD2").innerHTML = parseFloat(data[5]).toFixed(5);

          document.getElementById("CalM_DinD3").innerHTML = parseFloat(data[6]).toFixed(5);
          document.getElementById("CalB_DinD3").innerHTML = parseFloat(data[7]).toFixed(5);

          document.getElementById("DindSuhu1").innerHTML = parseFloat(data[8]).toFixed(2);
          document.getElementById("DindSuhu2").innerHTML = parseFloat(data[9]).toFixed(2);
          document.getElementById("DindSuhu3").innerHTML = parseFloat(data[10]).toFixed(2);
