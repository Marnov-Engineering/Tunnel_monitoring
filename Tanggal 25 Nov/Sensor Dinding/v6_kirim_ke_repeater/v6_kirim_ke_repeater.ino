...
static uint8_t sensorDinding3[] = { 0x4C, 0x11, 0xAE, 0x03, 0x64, 0xF1 };

unsigned long DelayPengiriman = 0;
bool ledState = LOW;
bool KirimKeRepeater = LOW;
